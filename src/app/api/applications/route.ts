...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log('Fetching interview-ready applications with parameters:', { 
    ...
    let data, error;
    try {
      ({ data, error } = await supabaseService.rpc("get_interview_applications_by_school", {
    ...
    console.log('RPC get applications: Response:', data);
