  ...
  return (
    <div className="space-y-6">
      <Card className="border-0 shadow-sm">
        {/* <CardHeader>
        <CardTitle className="text-xl font-semibold text-gray-800">Review & Publish</CardTitle>
        <p className="text-sm text-gray-500">Review everything before publishing.</p>
      </CardHeader> */}
      ...
      {/* Remove error and publish button UI */}
    </div>
  )
} 