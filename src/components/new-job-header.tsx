...
import { IconInnerShadowTop, IconX, IconArrowLeft } from "@tabler/icons-react"
    ...
    <header className="flex h-16 shrink-0 items-center gap-2 border-b transition-[width,height] ease-linear">
      <div className="flex w-full items-center gap-1 px-4 lg:gap-2 lg:px-6 py-2">
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          <Button variant="outline" size="icon" className="hidden sm:flex" title="Close" onClick={() => router.back()}>
            <IconX />
