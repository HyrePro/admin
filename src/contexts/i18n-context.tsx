...
const enTranslations: Translations = {
  ...
  'empty.noJobsMatchFilters': 'No Search Results',
  'empty.noJobsMatchFiltersDescription': 'Try adjusting your search or filter criteria to find what you\'re looking for.',
...
const esTranslations: Translations = {
  ...
  'empty.noJobsMatchFilters': 'Sin resultados de búsqueda',
  'empty.noJobsMatchFiltersDescription': 'Intente ajustar su búsqueda o criterios de filtro para encontrar lo que está buscando.',
...
const frTranslations: Translations = {
  ...
  'empty.noJobsMatchFilters': 'Aucun résultat de recherche',
  'empty.noJobsMatchFiltersDescription': 'Essayez d\'ajuster votre recherche ou vos critères de filtrage pour trouver ce que vous cherchez.',
...
const deTranslations: Translations = {
  ...
  'empty.noJobsMatchFilters': 'Keine Suchergebnisse',
  'empty.noJobsMatchFiltersDescription': 'Passen Sie Ihre Suche oder Filterkriterien an, um das Gewünschte zu finden.',
...
const zhTranslations: Translations = {
  ...
  'empty.noJobsMatchFilters': '没有搜索结果',
  'empty.noJobsMatchFiltersDescription': '请尝试调整搜索或筛选条件以找到您想要的内容。',
